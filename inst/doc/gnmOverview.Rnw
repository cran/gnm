%\VignetteIndexEntry{An overview of the gnm package}
...
estimates can be set by \Rfunarg{start} and parameters can be constrained via
\Rfunarg{constrain} and \Rfunarg{constrainTo} arguments. Parameters of a
